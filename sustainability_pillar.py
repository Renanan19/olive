# -*- coding: utf-8 -*-
"""
sustainability_pillar.py -- build THE root-level "sustainable olive oil" pillar
(x4 languages). Deeper than the blog guide; the canonical, most-citable hub for
the topic Bing AI cites the site most for (244 citations, 30-44% share).

Emits Article + HowTo + FAQPage + BreadcrumbList JSON-LD. The HowTo targets the
exact top query "how to determine if olive oil is sustainable". Root-relative
paths, hreflang cluster across the 4 language slugs, TOC, comparison + cert tables.
"""
...
SLUGS = {"fr": "huile-olive-durable", "en": "sustainable-olive-oil",
...
UI = {
    "fr": dict(idx="index-fr.html", nav="L'OR VERT", home="Accueil", crumb="Durabilité",
               ...
               cert="blog/certifications-bio-huile-olive-fr.html", certlbl="Certifications bio",
    ...
    "en": dict(idx="index-en.html", nav="L'OR VERT", home="Home", crumb="Sustainability",
               ...
               guide="blog/oleiculture-durable-en.html", guidelbl="Sustainable olive farming",
               cert="blog/certifications-bio-huile-olive-en.html", certlbl="Organic certifications",
    ...
    "it": dict(idx="index-it.html", nav="L'OR VERT", home="Home", crumb="Sostenibilità",
               ...
               guide="blog/oleiculture-durable-it.html", guidelbl="Olivicoltura sostenibile",
               cert="blog/certifications-bio-huile-olive-it.html", certlbl="Certificazioni bio",
    ...
    "el": dict(idx="index-el.html", nav="L'OR VERT", home="Αρχική", crumb="Βιωσιμότητα",
               ...
               guide="blog/oleiculture-durable-el.html", guidelbl="Βιώσιμη ελαιοκαλλιέργεια",
               cert="blog/certifications-bio-huile-olive-el.html", certlbl="Βιολογικές πιστοποιήσεις",
...
def render(lang, d):
    ...
    article = {
        ...
        "inLanguage": lang, "articleSection": "Sustainability",
        "image": OG, "keywords": d["keywords"], "isAccessibleForFree": True,
        "mainEntityOfPage": url,
    }
    howto = {
        "@context": "https://schema.org", "@type": "HowTo",
        "name": d["howto_name"], "description": d["howto_desc"],
        "inLanguage": lang,
    ...
    secs = []
    for sid, h, body in d["sections"]:
        secs.append(f'<h2 id="{sid}">{esc(h)}</h2>\n        {body}')
...
<main class="container">
    <article class="guide pillar-guide">
        ...
        <div class="pillar-linkbox">
            ...
            <a href="{ui['guide']}">{esc(ui['guidelbl'])}</a>
            <a href="{ui['cert']}">{esc(ui['certlbl'])}</a>
